...
export function ProductModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/50 p-4 backdrop-blur-sm md:items-center">
      <div className="relative max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-[2rem] bg-[var(--background)] shadow-2xl">
        <button
          onClick={onClose}
          className="absolute right-5 top-5 z-20 rounded-full bg-white/80 px-3 py-2 text-xs uppercase tracking-[0.2em] backdrop-blur-sm"
        >
          Cerrar
        </button>
